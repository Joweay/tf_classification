...
import generate_tfrecord as data_provider
import predictor
...
flags.DEFINE_string('output_path1', './val_result_15000_normalized.json', 'Path to output file.')
...
if __name__ == '__main__':
    ...
    images_dir = FLAGS.images_dir1
    annotation_path = FLAGS.annotation_path1
    output_path = FLAGS.output_path1
    ...
    for image_path, label in annotation_dict.items():
        ...
        image_name = image_path.split('/')[-1].decode('utf-8')
