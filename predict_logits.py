# -*- coding: utf-8 -*-
"""
Created on Mon Oct 29 19:25:31 2018
...
flags.DEFINE_string('output_path', 
                    './test_result_logit_8775_152_300.json',
                    'Path to output file.')
...
if __name__ == '__main__':
    ...
    for image_path in image_files:
        ...
        pred_logits = model.predict_logits([image])[0]
        pred_logits = [float(logit) for logit in pred_logits]

        d = {}
        d['image_id'] = image_name
        d['disease_class'] = pred_logits
